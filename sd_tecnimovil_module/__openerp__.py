...
Module that modifies the program interface and the reports to Tecnimovil
------------------------------------------------------------------------
* EDIT Header
* EDIT Footer
* EDIT Report invoice 
* EDIT Repor sale order
    ...
    'data': ['reports/footer_report.xml',
             ...
             'reports/mrprepairorder_report.xml',
             'views/inherit_mrp_view.xml'],
    'images':[],                
    'installable': True,
    'auto_install': False,        
    'application': False,
