function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.PosModel = Backbone.Model.extend({
        ...
        models: [
        {
            ...
            fields: ['display_name', 'list_price','price','pos_categ_id', 'taxes_id', 'ean13', 'default_code', 
                     'to_weight','discount', 'uom_id', 'uos_id', 'uos_coeff', 'mes_type', 'description_sale', 'description',
                     'product_tmpl_id'],
    ...
    module.Orderline = Backbone.Model.extend({
        initialize: function(attr,options){
        	if (options.product.discount > 0){
        		options.product.discount = parseFloat(options.product.discount).toFixed(2);
        	}
            ...
            this.quantity = 1;
            this.quantityStr = '1';
            this.discount = options.product.discount;
            this.discountStr = options.product.discount+'';
            this.type = 'unit';
            this.selected = false;
