...
Module that modifies the program interface and the reports to Ferretería El Cardón
----------------------------------------------------------------------------------
* EDIT Header
* EDIT Footer
* EDIT Report invoice 
* EDIT Repor sale order
    ...
    'depends' : ['web',
                 ...
                 'point_of_sale',
                 'product'],            
    'data': ['report/paper_format_a5.xml',
             ...
             'views/inherit_sale_and_res_partner_view.xml'],
    'images':[], 
    'installable': True,        
    'auto_install': False,        
    'application': False,
