...
class task(orm.Model):
    ...
    _columns = {
        'internal_description': fields.text('Description internal'),
        'material_ids': fields.one2many('project.task.materials', 'task_id', 'Materials used'),
        'internal_material_ids': fields.one2many('project.task.materials.internal', 'task_id', 'Materials used'),
    }
...
class project_task_materials_internal(orm.Model):
    _name = "project.task.materials.internal"
    _description = "Task Internal Materials Used"
